  ...
  group('$Firestore', () {
    ...
    group('$DocumentReference', () {
      ...
      test('get set', () {
        ...
        void doCheck() {
          ...
          var nestedData = data.getNestedData('nestedData')!;
      ...
      test('$DocumentData.toMap', () async {
        ...
        var docRef = result['refVal'] as DocumentReference;
        expect(docRef, const TypeMatcher<DocumentReference>());
        expect(docRef.path, 'users/23');
      ...
      test('delete field', () async {
        ...
        var fieldValueDelete = Firestore.fieldValues.delete();
      ...
      test('array field value', () async {
        ...
        // Make sure FieldValue class is exported by using it here
        var fieldValueArrayUnion = Firestore.fieldValues.arrayUnion([1, 2]);
        var fieldValueArrayUnion2 = Firestore.fieldValues.arrayUnion([10, 11]);
        var fieldValueArrayComplex = Firestore.fieldValues.arrayUnion([
          100,
          'text',
          {
            'sub': [1]
    ...
    group('$DocumentQuery', () {
      ...
      test('select', () async {
        ...
        var querySnapshot = await collRef.select(['field2']).get();
